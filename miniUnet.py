...
def WaveUNet(features):
    ...
    LAYERS = 8 	    #how deep is  your love (for source separation using U nets)
...
sess.run(init)
writer = tf.summary.FileWriter("trainlogMini", sess.graph);
...
for epo in range(EPOCHS):
    ...
    modelName = os.getcwd()+'/models/miniModels/'+str(epo)+'loss:'+str(loss_np)+'.ckpt'
